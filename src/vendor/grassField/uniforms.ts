...
export type BladeUniforms = {
  ...
  // ADRIATIC: shore band — see groundMask.ts. uShoreDirt = 0 disables it.
  uShoreDirtStart: THREE.IUniform<number>;
  uShoreDirtEnd: THREE.IUniform<number>;
  uShoreDirt: THREE.IUniform<number>;
...
export function createGrassFieldUniforms(): GrassFieldUniforms {
  return {
    surface: {
      ...
      uShoreDirtStart: { value: 0 },
      uShoreDirtEnd: { value: 0 },
      uShoreDirt: { value: 0 },
